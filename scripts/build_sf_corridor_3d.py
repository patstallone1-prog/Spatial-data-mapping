...
//: the cover the lidar measured over them. Each mesh is lifted once.
function liftOntoGround(object) {
  ...
  object.traverse((o) => {
    ...
    const attribute = o.geometry && o.geometry.getAttribute("position");
    if (!attribute) return;
...
// The tunnels are sunk below the flat ground: the planes under the world are cut along them,
// and everything at ground level stands on the ground the lidar measured.
